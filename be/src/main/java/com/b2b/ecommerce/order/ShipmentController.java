...
public class ShipmentController {
	...
	public ShipmentController(OrderService orders) {
		this.orders = orders;
	}
	...
	public ApiResponse<List<ShipmentDto>> shipments(
		...
		Page<ShipmentDto> result = orders.customerShipments(userId(userId), params, status);
	...
	public ApiResponse<ShipmentDto> shipment(
		...
		return ApiResponse.ok(orders.customerShipment(userId(userId), id));
	}
