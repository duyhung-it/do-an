...
const mockDocuments: Document[] = [
  // 3 tài liệu mua hàng
  {
    id: 'doc-001', name: 'Tài liệu mua hàng iPhone 15 Pro Max', fileName: 'MuaHang_iPhone15_2026.pdf', fileType: 'pdf', fileSize: 2_450_000,
    category: 'Hợp đồng', entityType: 'contract', entityId: 'contract-001', tags: ['điện thoại', 'bảo hành', '2026'], version: 2,
    uploadedBy: 'user-001', uploadedByName: 'Nguyễn Văn Mua', companyId: 'buyer-001', companyName: 'Khách hàng ABC',
    description: 'Tài liệu xác nhận điều khoản mua hàng và bảo hành iPhone 15 Pro Max', status: 'Hiệu lực',
    createdAt: '2026-01-15T08:30:00Z', updatedAt: '2026-02-01T10:00:00Z',
  },
  {
    id: 'doc-002', name: 'Phụ lục thanh toán đơn hàng', fileName: 'PL_ThanhToan_DonHang.docx', fileType: 'docx', fileSize: 580_000,
    category: 'Hợp đồng', entityType: 'contract', entityId: 'contract-001', tags: ['phụ lục', 'thanh toán'], version: 1,
    uploadedBy: 'user-002', uploadedByName: 'Nhân viên CELLPHONES', companyId: 'seller-001', companyName: 'CELLPHONES',
    description: 'Phụ lục bổ sung thông tin thanh toán cho đơn hàng giá trị cao', status: 'Hiệu lực',
    createdAt: '2026-01-20T09:00:00Z', updatedAt: '2026-01-20T09:00:00Z',
  },
  {
    id: 'doc-003', name: 'Tài liệu vận chuyển Q1/2026', fileName: 'VanChuyen_Q1.pdf', fileType: 'pdf', fileSize: 1_800_000,
    category: 'Hợp đồng', tags: ['vận chuyển', 'Q1'], version: 1,
    uploadedBy: 'user-001', uploadedByName: 'Nguyễn Văn Mua', companyId: 'buyer-001', companyName: 'Khách hàng ABC',
    description: 'Tài liệu điều phối vận chuyển đơn hàng trong quý 1 năm 2026', status: 'Lưu trữ',
  ...
  },
  {
    ...
    uploadedBy: 'user-002', uploadedByName: 'Nhân viên CELLPHONES', companyId: 'seller-001', companyName: 'CELLPHONES',
    description: 'Hoá đơn điều chỉnh do thay đổi phí vận chuyển', status: 'Hiệu lực',
    createdAt: '2026-02-20T08:00:00Z', updatedAt: '2026-02-20T08:00:00Z',
  },
  // 2 Chứng chỉ
  {
    id: 'doc-007', name: 'Phiếu bảo hành chính hãng', fileName: 'BaoHanh_ChinhHang.pdf', fileType: 'pdf', fileSize: 4_200_000,
    category: 'Chứng chỉ', tags: ['bảo hành', 'chính hãng'], version: 3,
    uploadedBy: 'user-002', uploadedByName: 'Nhân viên CELLPHONES', companyId: 'seller-001', companyName: 'CELLPHONES',
    description: 'Phiếu bảo hành chính hãng kèm theo sản phẩm điện thoại', status: 'Hiệu lực',
    createdAt: '2025-06-01T07:00:00Z', updatedAt: '2026-01-10T09:00:00Z',
  },
  {
    id: 'doc-008', name: 'Chứng nhận phân phối chính hãng', fileName: 'ChungNhan_PhanPhoi.png', fileType: 'png', fileSize: 3_100_000,
    category: 'Chứng chỉ', tags: ['phân phối', 'pháp lý'], version: 1,
    uploadedBy: 'user-002', uploadedByName: 'Nhân viên CELLPHONES', companyId: 'seller-001', companyName: 'CELLPHONES',
    description: 'Chứng nhận phân phối chính hãng cho nhóm sản phẩm điện thoại', status: 'Hiệu lực',
    createdAt: '2025-03-15T06:00:00Z', updatedAt: '2025-03-15T06:00:00Z',
  },
  // 2 Báo giá
  {
    id: 'doc-009', name: 'Bảng báo giá điện thoại Q1/2026', fileName: 'BaoGia_DienThoai_Q1.xlsx', fileType: 'xlsx', fileSize: 890_000,
    category: 'Báo giá', tags: ['điện thoại', 'Q1', 'báo giá'], version: 2,
    uploadedBy: 'user-002', uploadedByName: 'Nhân viên CELLPHONES', companyId: 'seller-001', companyName: 'CELLPHONES',
    description: 'Bảng báo giá chi tiết các mẫu điện thoại quý 1/2026', status: 'Hiệu lực',
    createdAt: '2026-01-05T08:00:00Z', updatedAt: '2026-01-12T10:00:00Z',
  },
  {
    id: 'doc-010', name: 'Báo giá phụ kiện', fileName: 'BaoGia_PhuKien.pdf', fileType: 'pdf', fileSize: 450_000,
    category: 'Báo giá', tags: ['phụ kiện', 'khuyến mãi'], version: 1,
    uploadedBy: 'user-003', uploadedByName: 'CSKH CELLPHONES', companyId: 'seller-002', companyName: 'CELLPHONES',
    description: 'Báo giá phụ kiện điện thoại theo chương trình khuyến mãi', status: 'Lưu trữ',
  ...
  // 2 GRN
  {
    ...
    category: 'GRN', entityType: 'grn', entityId: 'grn-001', tags: ['nhận hàng', 'điện thoại'], version: 1,
    uploadedBy: 'user-001', uploadedByName: 'Nguyễn Văn Mua', companyId: 'buyer-001', companyName: 'Khách hàng ABC',
    description: 'Biên bản nhận hàng điện thoại — đạt chất lượng', status: 'Hiệu lực',
  ...
  // 1 Khác
  {
    id: 'doc-015', name: 'Hướng dẫn sử dụng website bán hàng', fileName: 'Huong_dan_website.pdf', fileType: 'pdf', fileSize: 5_600_000,
    category: 'Khác', tags: ['hướng dẫn', 'nội bộ'], version: 1,
    uploadedBy: 'user-001', uploadedByName: 'Nguyễn Văn Mua', companyId: 'buyer-001', companyName: 'Khách hàng ABC',
    description: 'Tài liệu hướng dẫn sử dụng website bán hàng cho nhân viên', status: 'Hiệu lực',
...
export const documentApi = {
  ...
  async upload(data: Partial<Document>): Promise<Document> {
    ...
    const newDoc: Document = {
      ...
      companyName: data.companyName || 'Khách hàng',
